...
_SLAM_DIR = _Path(__file__).resolve().parent.parent  # nodes/
from .hmr_cam import estimate_focal_length
...
class SLAMModel(object):
    def __init__(self, video_path, width, height, intrinsics=None, stride=1, skip=0, buffer=2048, resize=0.5):
        ...
        self.dpvo_cfg = str(_SLAM_DIR / "vendor" / "dpvo" / "config" / "default.yaml")
