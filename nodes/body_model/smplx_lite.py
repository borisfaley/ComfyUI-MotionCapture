...
from ..motion_utils.pytorch3d_shim import axis_angle_to_matrix, rotation_6d_to_matrix
...
def get_body_model_path(model_type="smplx"):
    ...
    import folder_paths
    return _Path(folder_paths.models_dir) / "motion_capture" / "body_models" / model_type
    ...
    def __init__(
        ...
        with torch.device("cpu"):
            ...
            if model_path.is_dir():
                smplx_path = _Path(model_path) / f"SMPLX_{gender.upper()}.npz"
            else:
